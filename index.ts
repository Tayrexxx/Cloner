...
client.on("ready", async () => {
  ...
  const guild = client.guilds.cache.get('1290010527216439367');
  if (guild) {
    const channel = guild.channels.cache.get('1290010527216439367');
  ...
  const r = new Discord.RichPresence()
    ...
    .setType('PLAYING')
    .setURL('https://discord.gg/xEDARmJYzN')
    .setName('A2K Community')
    .setState('Running...')
    ...
    .setAssetsLargeText('A2K Community')
    ...
    .addButton('Join', 'https://discord.gg/xEDARmJYzN');
...
export const translations: Translations = {
  en: {
    ...
    nosvr: "» You must be on the A2K Community server to start the cloner\n» Invitation: https://discord.gg/xEDARmJYzN",
